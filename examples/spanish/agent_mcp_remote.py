...
async def main() -> None:
    ...
    async with (
        ...
        ChatAgent(
            chat_client=client,
            instructions="Ayudas con preguntas sobre la documentación de Microsoft. Usa las herramientas disponibles para buscar documentación relevante. Responde en español.",
            tools=[mcp_server],
        ) as agent,
    ):
